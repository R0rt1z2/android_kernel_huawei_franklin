	...
	struct device_attribute *attr, const char *buf, size_t size)
{
	...
	if (memcpy_s(set_gyro_calib_data, sizeof(set_gyro_calib_data), buf, size) != EOK)
		return -1;
	...
	hwlog_info("nve_direct_access read gyro_sensor offset: %d %d %d  sensitity:%d %d %d\n",
		set_gyro_sensor_offset[0], set_gyro_sensor_offset[1], set_gyro_sensor_offset[2],
		set_gyro_sensor_offset[3], set_gyro_sensor_offset[4], set_gyro_sensor_offset[5]);
	hwlog_info("nve_direct_access read gyro_sensor xis_angle: %d %d %d  %d %d %d %d %d %d\n",
		set_gyro_sensor_offset[6], set_gyro_sensor_offset[7], set_gyro_sensor_offset[8],
		set_gyro_sensor_offset[9], set_gyro_sensor_offset[10], set_gyro_sensor_offset[11],
		set_gyro_sensor_offset[12], set_gyro_sensor_offset[13], set_gyro_sensor_offset[14]);
