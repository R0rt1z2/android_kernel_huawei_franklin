	...
	struct device_attribute *attr, const char *buf, size_t size)
{
	...
	hwlog_info("nve_direct_access read acc_sensor offset: %d %d %d  sensitity:%d %d %d\n",
		set_acc_sensor_offset[0], set_acc_sensor_offset[1], set_acc_sensor_offset[2],
		set_acc_sensor_offset[3], set_acc_sensor_offset[4], set_acc_sensor_offset[5]);
	hwlog_info("nve_direct_access read acc_sensor xis_angle: %d %d %d  %d %d %d %d %d %d\n",
		set_acc_sensor_offset[6], set_acc_sensor_offset[7], set_acc_sensor_offset[8],
		set_acc_sensor_offset[9], set_acc_sensor_offset[10], set_acc_sensor_offset[11],
		set_acc_sensor_offset[12], set_acc_sensor_offset[13], set_acc_sensor_offset[14]);
	...
	struct device_attribute *attr, const char *buf, size_t size)
{
	...
	hwlog_info("nve_direct_access read acc1_sensor offset: %d %d %d  sensitity:%d %d %d\n",
		set_acc1_sensor_offset[0], set_acc1_sensor_offset[1], set_acc1_sensor_offset[2],
		set_acc1_sensor_offset[3], set_acc1_sensor_offset[4], set_acc1_sensor_offset[5]);
	hwlog_info("nve_direct_access read acc1_sensor xis_angle: %d %d %d  %d %d %d %d %d %d\n",
		set_acc1_sensor_offset[6], set_acc1_sensor_offset[7], set_acc1_sensor_offset[8],
		set_acc1_sensor_offset[9], set_acc1_sensor_offset[10], set_acc1_sensor_offset[11],
		set_acc1_sensor_offset[12], set_acc1_sensor_offset[13], set_acc1_sensor_offset[14]);
