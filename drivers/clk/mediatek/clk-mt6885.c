...
#define INFRA_CG0	0x03AF8200	/* pwm: 21~15, uart:23,24,25 */
...
static const struct mtk_mux top_muxes[] __initconst = {
	...
	MUX_CLR_SET_UPD(TOP_MUX_BUS_AXIMEM, "bus_aximem_sel",
		bus_aximem_parents,
		CLK_CFG_0, CLK_CFG_0_SET, CLK_CFG_0_CLR,
		24, 3, INV_MUX_GATE, CLK_CFG_UPDATE,
		TOP_MUX_BUS_AXIMEM_UPD_SHIFT),
	/* CLK_CFG_1 */
	...
	MUX_CLR_SET_UPD(TOP_MUX_AUD_INTBUS, "aud_intbus_sel",
		...
		0, 2, INV_MUX_GATE, CLK_CFG_UPDATE1,
		TOP_MUX_AUD_INTBUS_UPD_SHIFT),
	MUX_CLR_SET_UPD(TOP_MUX_PWRAP_ULPOSC, "pwrap_ulposc_sel",
		pwrap_ulposc_parents,
		CLK_CFG_8, CLK_CFG_8_SET, CLK_CFG_8_CLR,
		8, 3, INV_MUX_GATE, CLK_CFG_UPDATE1,
		TOP_MUX_PWRAP_ULPOSC_UPD_SHIFT),
	...
	MUX_CLR_SET_UPD(TOP_MUX_DP, "dp_sel", dp_parents,
		...
		0, 3, INV_MUX_GATE, CLK_CFG_UPDATE1, TOP_MUX_DP_UPD_SHIFT),
	...
	MUX_CLR_SET_UPD(TOP_MUX_SENINF, "seninf_sel", seninf_parents,
		CLK_CFG_10, CLK_CFG_10_SET, CLK_CFG_10_CLR,
		16, 3, INV_MUX_GATE, CLK_CFG_UPDATE1,
		TOP_MUX_SENINF_UPD_SHIFT),
	MUX_CLR_SET_UPD(TOP_MUX_SENINF1, "seninf1_sel", seninf1_parents,
		CLK_CFG_10, CLK_CFG_10_SET, CLK_CFG_10_CLR,
		24, 3, INV_MUX_GATE, CLK_CFG_UPDATE1,
		TOP_MUX_SENINF1_UPD_SHIFT),
	/* CLK_CFG_11 */
...
static const struct mtk_gate infra_clks[] __initconst = {
	...
	GATE(INFRACFG_AO_AES_UFSFDE_CG, "infracfg_ao_aes_ufs_cg",
			"aes_ufsfde_sel",
...
static void __init mtk_topckgen_init(struct device_node *node)
{
	...
	clk_writel(cksys_base + CLK_CFG_6_SET, 0x00808080);
