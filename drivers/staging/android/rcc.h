...
struct rcc_module {
	...
	/* count the sleep reason of rcc */
	unsigned long long      sleep_reason[RCC_S_REASON_NUM];
	/* count the stop reason of rcc */
	unsigned long long      stop_reason[RCC_S_REASON_NUM];
};
