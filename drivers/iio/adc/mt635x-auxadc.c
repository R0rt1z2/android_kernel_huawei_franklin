...
static struct mt635x_auxadc_device *g_adc_dev;

int mt635x_auxadc_get_sample(int channel)
{
	struct mt635x_auxadc_device *adc_dev = g_adc_dev;
	...
	return get_auxadc_out(adc_dev, channel);
}

int mt635x_auxadc_get_voltage(int channel)
{
	struct auxadc_channels *auxadc_chan = NULL;
	struct mt635x_auxadc_device *adc_dev = g_adc_dev;
	int val;
