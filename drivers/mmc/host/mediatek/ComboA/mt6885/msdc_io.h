...
#define LDO_POWER_ON 1
#define LDO_POWER_OFF 0
#define LDO_NDIS_ENABLE 1
#define LDO_NDIS_DISABLE 0
#define POWER_OFF_DELAY_MS_TIME 50
#define POWER_ON_SD_DELAY_MS_TIME 400
