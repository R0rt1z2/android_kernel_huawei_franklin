...
void dump_mmc_gpio_info(void)
{
	...
	pr_info("MSDC1 MODE5: 0x%08x should: 0x000*****\n",
		MSDC_READ32(MSDC1_GPIO_MODE5));
	pr_info("MSDC1 MODE6: 0x%08x should: 0x11111***\n",
		MSDC_READ32(MSDC1_GPIO_MODE6));
	pr_info("MSDC1 MODE7: 0x%08x should: 0x*******1\n",
		MSDC_READ32(MSDC1_GPIO_MODE7));
	pr_info("MSDC1 IES: 0x%08x 14-9bits should: 2b111111\n",
		MSDC_READ32(MSDC1_GPIO_IES));
	pr_info("MSDC1 SMT: 0x%08x 9-4bits should: 2b111111\n",
		MSDC_READ32(MSDC1_GPIO_SMT));
	pr_info("MSDC1 DRV0: 0x%08x\n", MSDC_READ32(MSDC1_GPIO_DRV0));
	pr_info("MSDC1 PUPD0: 0x%08x should: 0x******01\n",
		MSDC_READ32(MSDC1_GPIO_PUPD0));
	pr_info("MSDC1 R0: 0x%08x should: 0x******00\n",
		MSDC_READ32(MSDC1_GPIO_R0));
	pr_info("MSDC1 R1: 0x%08x should: 0x******3F\n",
