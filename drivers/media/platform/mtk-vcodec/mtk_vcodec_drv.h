...
enum mtk_encode_param {
	...
	MTK_ENCODE_PARAM_MAX_QP = (1 << 16),
	MTK_ENCODE_PARAM_MIN_QP = (1 << 17),
	MTK_ENCODE_PARAM_I_P_QP_DELTA = (1 << 18),
	MTK_ENCODE_PARAM_QP_CONTROL_MODE = (1 << 19),
	MTK_ENCODE_PARAM_FRAME_LEVEL_QP = (1 << 20),
	MTK_ENCODE_PARAM_ENCODE_LOW_LATENCY = (1 << 21),
	MTK_ENCODE_PARAM_LTR_MODE = (1 << 22),
};
