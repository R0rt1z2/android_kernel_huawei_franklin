 ...
 * hi6526_tcpm.h
 *
 * Hi6526 tcpm interface defination
 *
...
enum pd_connect_result {
	HI6526_PD_CONNECT_NONE = 0,
	HI6526_PD_CONNECT_TYPEC_ONLY, /* Internal Only */
	HI6526_PD_CONNECT_TYPEC_ONLY_SNK_DFT,
	HI6526_PD_CONNECT_TYPEC_ONLY_SNK,
	HI6526_PD_CONNECT_TYPEC_ONLY_SRC,
	HI6526_PD_CONNECT_PE_READY, /* Internal Only */
	HI6526_PD_CONNECT_PE_READY_SNK,
	HI6526_PD_CONNECT_PE_READY_SRC,

	/* CONFIG_USB_PD_CUSTOM_DBGACC_SUPPORT */
	HI6526_PD_CONNECT_PE_READY_DBGACC_UFP,
	HI6526_PD_CONNECT_PE_READY_DBGACC_DFP,
};
...
enum {
	HI6526_TCP_NOTIFY_DIS_VBUS_CTRL,
	HI6526_TCP_NOTIFY_SOURCE_VCONN,
	HI6526_TCP_NOTIFY_SOURCE_VBUS,
	HI6526_TCP_NOTIFY_SINK_VBUS,
	HI6526_TCP_NOTIFY_PR_SWAP,
	HI6526_TCP_NOTIFY_DR_SWAP,
	HI6526_TCP_NOTIFY_VCONN_SWAP,
	HI6526_TCP_NOTIFY_ENTER_MODE,
	HI6526_TCP_NOTIFY_EXIT_MODE,
	HI6526_TCP_NOTIFY_AMA_DP_STATE,
	HI6526_TCP_NOTIFY_AMA_DP_ATTENTION,
	HI6526_TCP_NOTIFY_AMA_DP_HPD_STATE,

	HI6526_TCP_NOTIFY_TYPEC_STATE,
	HI6526_TCP_NOTIFY_PD_STATE,

	/* CONFIG_USB_PD_UVDM_SUPPORT */
	HI6526_TCP_NOTIFY_UVDM,

	HI6526_TCP_NOTIFY_CABLE_VDO,

	/* PD V30 */
	HI6526_TCP_NOTIFY_ALERT,
	HI6526_TCP_NOTIFY_STATUS,
	HI6526_TCP_NOTIFY_PPS_STATUS,
	HI6526_TCP_NOTIFY_PPS_READY,
};
...
int hi6526_tcpm_typec_set_wake_lock(struct hi6526_tcpc_device *tcpc, bool user_lock);
...
int hi6526_tcpm_typec_notify_direct_charge(struct hi6526_tcpc_device *tcpc_dev, bool dc);
int hi6526_tcpm_typec_change_role(struct hi6526_tcpc_device *tcpc_dev, uint8_t typec_role);
...
int hi6526_tcpm_get_source_cap(struct hi6526_tcpc_device *tcpc_dev, struct tcpm_power_cap *cap);
int hi6526_tcpm_get_sink_cap(struct hi6526_tcpc_device *tcpc_dev, struct tcpm_power_cap *cap);
...
int hi6526_tcpm_send_uvdm(struct hi6526_tcpc_device *tcpc_dev, uint8_t cnt,
...
typedef int (*tcp_dpm_event_cb)(
	struct hi6526_tcpc_device *tcpc, int ret, struct tcp_dpm_event *event);
