...
int hi6526_tcpci_timer_init(struct hi6526_tcpc_device *tcpc);
int hi6526_tcpci_timer_deinit(struct hi6526_tcpc_device *tcpc);
...
void hi6526_tcpc_disable_timer(struct hi6526_tcpc_device *tcpc, uint32_t timer_id);
...
void hi6526_tcpc_reset_pe_timer(struct hi6526_tcpc_device *tcpc);
