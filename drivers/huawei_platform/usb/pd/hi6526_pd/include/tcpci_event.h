...
bool hi6526_pd_put_event(struct hi6526_tcpc_device *tcpc_dev,
...
bool hi6526_pd_put_vdm_event(struct hi6526_tcpc_device *tcpc_dev, pd_event_t *pd_event,
...
bool hi6526_pd_put_deferred_tcp_event(struct hi6526_tcpc_device *tcpc_dev,
 ...
 */
static inline uint8_t hi6526_pd_convert_through_u8(uint8_t value)
{
	return value;
}
