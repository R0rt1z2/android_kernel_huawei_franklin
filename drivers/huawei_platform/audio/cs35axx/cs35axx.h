...
#define CS35L41_AMP_VOL_RAMP_1MS_6DB	0x2
...
#define CS35L41_TEMP_WARN_RISE		0x8000
#define CS35L41_TEMP_WARN_FALL	0x10000
...
#define CS35L41_DSP1_RESET_MASK		0x200
#define CS35L41_DSP1_RESET_SHIFT	9

#define CS35L41_DSP1_EN_MASK		0x1
#define CS35L41_DSP1_EN_SHIFT		0

#define CS35L41_HALO_STATE_RUNNING	0x2
...
#define CS35L41_SFT_RESET_VAL	0x5A000000

#define CS35L41_DSP_N_RX_RATES		8
#define CS35L41_DSP_N_TX_RATES		8
#define HALO_SCRATCH1				0x005c0
#define CS35L41_HALO_CORE_RESET		0x00000200
#define CS35L41_HALO_CCM_CORE_CONTROL	0x41000

#define CS35L41_SPI_MAX_FREQ_OTP	4000000

#define CS35L41_ALGO_ID_SIZE		4
#define CS35L41_COEFF_COUNT_SIZE	4
#define CS35L41_COEFF_OFFSET_SIZE	2
#define CS35L41_COEFF_TYPE_SIZE		2
#define CS35L41_COEFF_LENGTH_SIZE	4

#define CS35L41_DSP_TIMEOUT_COUNT	20	/* 1 count = 10 ms */

#define CS35L41_MAX_WLEN		4096

#define CS35L41_XM_UNPACKED_TYPE	0x05
#define CS35L41_YM_UNPACKED_TYPE	0x06
#define CS35L41_PM_PACKED_TYPE		0x10
#define CS35L41_XM_PACKED_TYPE		0x11
#define CS35L41_YM_PACKED_TYPE		0x12
#define CS35L41_ALGO_INFO_TYPE		0xF2

#define CS35L41_FW_FILE_HEADER_SIZE	40
#define CS35L41_FW_DBLK_OFFSET_SIZE	3
#define CS35L41_FW_DBLK_TYPE_SIZE	1
#define CS35L41_FW_DBLK_LENGTH_SIZE	4

#define CS35L41_WT_FILE_HEADER_SIZE	16
#define CS35L41_WT_DBLK_OFFSET_SIZE	2
#define CS35L41_WT_DBLK_TYPE_SIZE	2
#define CS35L41_WT_ALGO_ID_SIZE		4
#define CS35L41_WT_ALGO_REV_SIZE	4
#define CS35L41_WT_SAMPLE_RATE_SIZE	4
#define CS35L41_WT_DBLK_LENGTH_SIZE	4

#define CS35L41_XM_FW_ID		(CS35L41_DSP1_XMEM_UNPACK24_0 + 12)
#define CS35L41_XM_NUM_ALGOS		(CS35L41_DSP1_XMEM_UNPACK24_0 + 36)
#define CS35L41_ALGO_ID_OFFSET		0
#define CS35L41_ALGO_REV_OFFSET		4
#define CS35L41_ALGO_XM_BASE_OFFSET	8
#define CS35L41_ALGO_XM_SIZE_OFFSET	12
#define CS35L41_ALGO_YM_BASE_OFFSET	16
#define CS35L41_ALGO_YM_SIZE_OFFSET	20
#define CS35L41_ALGO_ENTRY_SIZE		24
#define CS35L41_ALGO_LIST_TERM		0xBEDEAD
#define CS35L41_ALGO_REV_MASK		0xFF0000

#define CS35L41_NUM_ALGOS_MAX		16

#define CS35L41_FW_NAME			"cs35axx.wmfw"
#define CS35L41_FW_DIAG_NAME		"cs35axx-diag.wmfw"
#define CS35L41_FW_ID_MATCH_A0		0x0400A4
#define CS35L41_FW_REV_MIN_A0		0x050102

//now support 2 boxes, every box has 9 tunings (0-7 normal , 8 calibration)
#define CONFIG_NUM	10
#define AAC_BOX_NUM	0
#define GV_BOX_NUM	1
#define BOX_NUM			2

static char *CS35L41_COEFF0_NAME[BOX_NUM][CONFIG_NUM] = {
{"cs35axx-aac-music.bin",
	"cs35axx-aac-ringtone.bin",
	"cs35axx-aac-ringtone_hs_spk.bin",
	"cs35axx-aac-incall.bin",
	"cs35axx-aac-voip.bin",
	"cs35axx-aac-lowpower.bin",
	"cs35axx-aac-mmi.bin",
	"cs35axx-aac-default.bin",
	"cs35axx-aac-calib.bin",
	"cs35axx-aac-lowtemp.bin",},
	
{"cs35axx-gv-music.bin",
	"cs35axx-gv-ringtone.bin",
	"cs35axx-gv-ringtone_hs_spk.bin",
	"cs35axx-gv-incall.bin",
	"cs35axx-gv-voip.bin",
	"cs35axx-gv-lowpower.bin",
	"cs35axx-gv-mmi.bin",
	"cs35axx-gv-default.bin",
	"cs35axx-gv-calib.bin",
	"cs35axx-gv-lowtemp.bin",},	
};

enum cs35l41_config {
	CS35L41_CONFIG_MUSIC = 0,
	CS35L41_CONFIG_RING,
	CS35L41_CONFIG_RING_HS_SPK,
	CS35L41_CONFIG_INCALL,
	CS35L41_CONFIG_VOIP,
	CS35L41_CONFIG_LOWPOWER,
	CS35L41_CONFIG_MMI,
	CS35L41_CONFIG_DEFAULT,
	CS35L41_CONFIG_CALIB,
	CS35L41_CONFIG_LOWTEMP,
};

static enum low_temreture_enum {
	LOW_TEMP_STATE_DEFAULT = 0,
	LOW_TEMP_STATE_IN_STAGE1,
	LOW_TEMP_STATE_IN_STAGE2,
	LOW_TEMP_STATE_OUT,
	LOW_TEMP_STATE_UNCHANGED	
};
...
//#define CS35L41_CALIB_NAME		"cs35l41-calib.bin"
...
extern int regcache_write(struct regmap *map, unsigned int reg,
													unsigned int value);
