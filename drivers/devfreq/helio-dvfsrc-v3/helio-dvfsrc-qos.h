...
struct helio_dvfsrc {
	...
	struct notifier_block	pm_qos_memory_lat_nb;
#endif
...
#ifdef CONFIG_HUAWEI_DRAM_FREQ_CONTROL
extern struct pm_qos_request dvfsrc_memory_latency_req;
extern int get_freq_info(void);
extern int get_freq_ddr_opp(int ddr_freq);
#endif
