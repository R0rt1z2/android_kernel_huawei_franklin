...
struct flashlight_ops {
	...
	int (*set_regulator_driver)(struct flashlight_device *dev,
		struct notifier_block *np);
	int (*set_torch_current)(struct flashlight_device *dev,
		int min_uA, int max_uA);
	int (*set_strobe_current)(struct flashlight_device *dev,
		int min_uA, int max_uA);
	int (*set_reg_current)(struct flashlight_device *dev,
		int min_uA, int max_uA);
};
...
extern int flashlight_set_regulator_driver(
		struct flashlight_device *flashlight_dev,
		struct notifier_block *np);


extern int flashlight_set_torch_current(struct flashlight_device *flashlight_dev,
	int min_uA, int max_uA);

extern int flashlight_set_strobe_current(struct flashlight_device *flashlight_dev,
	int min_uA, int max_uA);

extern int flashlight_set_reg_current(struct flashlight_device *flashlight_dev,
	int min_uA, int max_uA);
