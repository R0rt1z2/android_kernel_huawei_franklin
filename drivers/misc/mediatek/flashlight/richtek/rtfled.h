...
int (*rt_hal_fled_reg_current_list)
		(struct rt_fled_dev *fled_dev, int selector);
int (*rt_hal_fled_set_reg_current)
	(struct rt_fled_dev *fled_dev, int min_uA, int max_uA, int *selector);
int (*rt_hal_fled_set_reg_current_sel)(struct rt_fled_dev *fled_dev, int selector);
int (*rt_hal_fled_reg_set_driver)(struct rt_fled_dev *fled,
