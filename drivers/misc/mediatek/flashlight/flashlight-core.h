...
struct flash_error_table_t {
	u8 error_mask;
	flag_mask_mode_t mask_mode;
	int error_no;
	const char *error_info;
};

struct flash_error_info_t {
	u8 reg_addr;
	struct flash_error_table_t error_table[MAX_ERROR_SIZE];
	unsigned int size;
};
