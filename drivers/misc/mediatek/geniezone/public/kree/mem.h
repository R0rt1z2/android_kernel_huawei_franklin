...
#else /* Disable CONFIG_MTK_IN_HOUSE_TEE_SUPPORT and CONFIG_MTK_GZ_KREE */
...
static inline TZ_RESULT KREE_RegisterSharedmem(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE *shm_handle,
	KREE_SHAREDMEM_PARAM *param)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_UnregisterSharedmem(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE shm_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_AllocChunkmem(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE *cm_handle,
	KREE_SHAREDMEM_PARAM *param)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_UnregisterChunkmem(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE cm_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}
...
static inline TZ_RESULT KREE_AllocSecuremem(
...
static inline TZ_RESULT KREE_AllocSecurememWithTag(
	KREE_SESSION_HANDLE session, KREE_SECUREMEM_HANDLE *mem_handle,
...
static inline TZ_RESULT KREE_ZallocSecurememWithTag(
	KREE_SESSION_HANDLE session, KREE_SECUREMEM_HANDLE *mem_handle,
	uint32_t alignment, uint32_t size)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_ReferenceSecuremem(
	KREE_SESSION_HANDLE session, KREE_SECUREMEM_HANDLE mem_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_UnreferenceSecuremem(
	KREE_SESSION_HANDLE session, KREE_SECUREMEM_HANDLE mem_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_ReleaseSecurechunkmem(
	KREE_SESSION_HANDLE session, uint32_t *size)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_ReleaseSecureMultichunkmem(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE cm_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_ReleaseSecureMultichunkmem_basic(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE cm_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_AppendSecurechunkmem(KREE_SESSION_HANDLE session)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}
static inline TZ_RESULT KREE_AppendSecureMultichunkmem(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE *cm_handle,
	KREE_SHAREDMEM_PARAM *param)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_AppendSecureMultichunkmem_basic(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE *cm_handle,
	KREE_SHAREDMEM_PARAM *param)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_AllocSecureMultichunkmem(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE chm_handle,
	KREE_SECUREMEM_HANDLE *mem_handle, uint32_t alignment, uint32_t size)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_ZallocSecureMultichunkmem(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE chm_handle,
	KREE_SECUREMEM_HANDLE *mem_handle, uint32_t alignment, uint32_t size)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_ReferenceSecureMultichunkmem(
	KREE_SESSION_HANDLE session, KREE_SECUREMEM_HANDLE mem_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_UnreferenceSecureMultichunkmem(
	KREE_SESSION_HANDLE session, KREE_SECUREMEM_HANDLE mem_handle,
	uint32_t *count)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_ION_AllocChunkmem(KREE_SESSION_HANDLE session,
					       KREE_SHAREDMEM_HANDLE chm_handle,
					       KREE_ION_HANDLE_PTR IONHandle,
					       uint32_t alignment,
					       uint32_t size)
...
static inline TZ_RESULT KREE_ION_ZallocChunkmem(
	KREE_SESSION_HANDLE session, KREE_SHAREDMEM_HANDLE chm_handle,
	KREE_ION_HANDLE_PTR IONHandle, uint32_t alignment, uint32_t size)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_ION_ReferenceChunkmem(KREE_SESSION_HANDLE session,
						   KREE_ION_HANDLE IONHandle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_ION_UnreferenceChunkmem(
	KREE_SESSION_HANDLE session, KREE_ION_HANDLE IONHandle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_QueryChunkmem_TEST(KREE_SESSION_HANDLE session,
						KREE_ION_HANDLE IONHandle,
						uint32_t cmd)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_ION_QueryChunkmem_TEST(KREE_SESSION_HANDLE session,
						    KREE_ION_HANDLE IONHandle,
						    uint32_t cmd)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_ION_AccessChunkmem(KREE_SESSION_HANDLE session,
...
static inline TZ_RESULT KREE_ION_CP_Chm2Shm(KREE_SESSION_HANDLE session,
					    KREE_ION_HANDLE ION_Handle,
...
static inline uint32_t _IONHandle2MemHandle(KREE_ION_HANDLE IONHandle,
					    KREE_SECUREMEM_HANDLE *mem_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_AllocSecurechunkmem(
	KREE_SESSION_HANDLE session, KREE_SECURECM_HANDLE *cm_handle,
	uint32_t alignment, uint32_t size)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_AllocSecurechunkmemWithTag(
	KREE_SESSION_HANDLE session, KREE_SECURECM_HANDLE *cm_handle,
	uint32_t alignment, uint32_t size, const char *tag)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_ZallocSecurechunkmemWithTag(
	KREE_SESSION_HANDLE session, KREE_SECURECM_HANDLE *cm_handle,
	uint32_t alignment, uint32_t size, const char *tag)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_ReferenceSecurechunkmem(
	KREE_SESSION_HANDLE session, KREE_SECURECM_HANDLE cm_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_UnreferenceSecurechunkmem(
	KREE_SESSION_HANDLE session, KREE_SECURECM_HANDLE cm_handle)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_ReadSecurechunkmem(KREE_SESSION_HANDLE session,
...
static inline TZ_RESULT KREE_WriteSecurechunkmem(KREE_SESSION_HANDLE session,
						 uint32_t offset, uint32_t size,
						 void *buffer)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_GetSecurechunkReleaseSize(
	KREE_SESSION_HANDLE session, uint32_t *size)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}

static inline TZ_RESULT KREE_StartSecurechunkmemSvc(KREE_SESSION_HANDLE session,
...
static inline TZ_RESULT KREE_StopSecurechunkmemSvc(KREE_SESSION_HANDLE session,
						   unsigned long *cm_pa,
						   uint32_t *size)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_QuerySecurechunkmem(KREE_SESSION_HANDLE session,
						 unsigned long *cm_pa,
						 uint32_t *size)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline TZ_RESULT KREE_ConfigSecureMultiChunkMemInfo(
	KREE_SESSION_HANDLE session, uint64_t pa, uint32_t size,
	uint32_t region_id)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}
...
static inline TZ_RESULT KREE_ServGetChunkmemPool(
	u32 op, u8 uparam[REE_SERVICE_BUFFER_SIZE])
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}


static inline TZ_RESULT KREE_ServReleaseChunkmemPool(
	u32 op, u8 uparam[REE_SERVICE_BUFFER_SIZE])
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}
...
#endif /* CONFIG_MTK_IN_HOUSE_TEE_SUPPORT || CONFIG_MTK_GZ_KREE*/
