...
static inline void KREE_SESSION_LOCK(int32_t handle)
{
}

static inline void KREE_SESSION_UNLOCK(int32_t handle)
{
}


static inline int gz_get_cpuinfo_thread(void *data)
{
	return -ENOENT;
}

static inline void set_gz_bind_cpu(int on)
{
}

static inline int get_gz_bind_cpu(void)
{
	return -ENOENT;
}

static inline int ree_dummy_thread(void *data)
{
	return -ENOENT;
}
...
static inline int gz_do_m4u_map(KREE_SHAREDMEM_HANDLE handle,
				phys_addr_t pa, uint32_t size,
				uint32_t region_id)
{
	return -ENOENT;
...
static inline int gz_do_m4u_umap(KREE_SHAREDMEM_HANDLE handle)
{
	return -ENOENT;
}
#endif
...
static inline TZ_RESULT KREE_CreateSessionWithTag(const char *ta_uuid,
						  KREE_SESSION_HANDLE *pHandle,
						  const char *tag)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
...
static inline u64 KREE_GetSystemCnt(void)
{
	return 0;
}

static inline u32 KREE_GetSystemCntFrq(void)
{
	return 0;
}

static inline TZ_RESULT KREE_SessionToTID(KREE_SESSION_HANDLE session,
					  enum tee_id_t *o_tid)
{
	return TZ_RESULT_ERROR_NOT_SUPPORTED;
}
