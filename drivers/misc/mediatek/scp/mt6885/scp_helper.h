...
#define SCP_DRAM_MAPSIZE	(0xA00000)
...
struct scp_region_info_st {
	...
	uint32_t scp_logbuff_start;
	uint32_t scp_logbuff_size;
	uint32_t shmem_start;
	uint32_t flp_reserved_mem_start;
	uint32_t als_reserved_mem_start;
	uint32_t cfg_reserved_mem_start;
};
