...
#include "scp_l1c.h"
#include "xhub_router/recovery.h"
...
#if defined(CONFIG_MACH_MT6885) && defined(XHUB_SAVE_DUMPFILES)
	/* write dump to fs */
	save_sh_dump_file((void *)scp_dump.ramdump, scp_dump.ramdump_length);
#endif
