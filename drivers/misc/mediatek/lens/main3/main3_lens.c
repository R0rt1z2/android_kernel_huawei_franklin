...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	{ 1, AFDRV_DW9781BAF, dw9781baf_set_i2c_client, dw9781baf_ioctl,
		dw9781baf_release, dw9781baf_get_file_name, NULL },
	{ 1, AFDRV_AK7375AFD, ak7375afd_set_i2c_client, ak7375afd_ioctl,
		ak7375afd_release, ak7375afd_get_file_name, NULL },
	{ 1, AFDRV_LC898219AF, lc898219af_set_i2c_client, lc898219af_ioctl,
		lc898219af_release, lc898219af_get_file_name, NULL },
};
...
#ifdef CONFIG_OF
static const struct of_device_id gmain3af_of_device_id[] = {
	{.compatible = "mediatek,camera_main3_af_lens",},
	{}
};
#endif
...
static struct platform_driver g_stAF_Driver = {
	...
	.driver = {
		...
		.owner = THIS_MODULE,
#ifdef CONFIG_OF
		.of_match_table = gmain3af_of_device_id,
#endif
	}
};
...
late_initcall(MAIN3AF_i2C_init);
#else
