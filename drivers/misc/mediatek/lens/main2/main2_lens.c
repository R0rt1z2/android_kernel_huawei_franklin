...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	{ 1, AFDRV_DW9800AF, dw9800af_set_i2c_client, dw9800af_ioctl,
		dw9800af_release, dw9800af_get_file_name, NULL },
	{ 1, AFDRV_AK7375AF, ak7375afa_set_i2c_client, ak7375afa_ioctl,
		ak7375afa_release, ak7375afa_get_file_name, NULL },
};
...
#ifdef CONFIG_OF
static const struct of_device_id gmain2af_of_device_id[] = {
	{.compatible = "mediatek,camera_main2_af_lens",},
	{}
};
#endif
...
static struct platform_driver g_stAF_Driver = {
	...
	.driver = {
		...
		.owner = THIS_MODULE,
#ifdef CONFIG_OF
		.of_match_table = gmain2af_of_device_id,
#endif
	} };
...
late_initcall(MAIN2AF_i2C_init);
#else
