...
extern int dw9800af_set_i2c_client(struct i2c_client *af_i2c_client,
				spinlock_t *af_spin_lock, int *af_opened);
extern long dw9800af_ioctl(struct file *a_file, unsigned int a_command,
				unsigned long a_param);
extern int dw9800af_release(struct inode *a_inode, struct file *a_file);
extern int dw9800af_get_file_name(unsigned char *file_name);

extern int ak7375afa_set_i2c_client(struct i2c_client *af_i2c_client,
			spinlock_t *af_spin_Lock, int *af_opened);
extern long ak7375afa_ioctl(struct file *a_file, unsigned int a_command,
			unsigned long a_param);
extern int ak7375afa_release(struct inode *a_inode, struct file *a_file);
extern int ak7375afa_get_file_name(unsigned char *file_name);
