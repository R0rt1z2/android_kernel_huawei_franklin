...
long ak7375af_ioctl(struct file *a_file, unsigned int a_command,
...
int ak7375af_release(struct inode *a_inode, struct file *a_file)
{
	log_info("Start\n");
...
int ak7375af_set_i2c_client(struct i2c_client *af_i2c_client,
...
int ak7375af_get_file_name(unsigned char *file_name)
{
