/*
 * hi846_sunny_sensor.c
 *
 * Copyright (c) 2018-2019 Huawei Technologies Co., Ltd.
 *
 * hi846_sunny image sensor driver
 *
...
#define PFX "[hi846_sunny]"
#define DEBUG_HI846_SUNNY 0
#define LOG_DBG(fmt, args...) \
	do { \
		if (DEBUG_HI846_SUNNY) \
...
static kal_uint32 feature_control_hi846_sunny(MSDK_SENSOR_FEATURE_ENUM feature_id,
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	get_info,
	get_resolution,
	feature_control_hi846_sunny,
	control,
	close
};

UINT32 HI846_SUNNY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pf_func)
{
	if (pf_func != NULL)
		*pf_func = &sensor_func;
	return ERROR_NONE;
