/*
 * ov16a1q_ofilm_sensor.c
 *
 * Copyright (c) 2018-2019 Huawei Technologies Co., Ltd.
 *
 * ov16a1q_ofilm image sensor driver
 *
...
#include "ov16a1q_ofilm_sensor.h"
...
#define OV16A1Q_MAXGAIN 16
#define RETRY_TIMES 2

/* Modify Following Strings for Debug */
#define PFX "[ov16a1q_ofilm]"
#define DEBUG_OV16A1Q_OFILM 0
#define LOG_DBG(fmt, args...) \
	do { \
		if (DEBUG_OV16A1Q_OFILM) \
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (gain < BASEGAIN) {
		...
		gain = BASEGAIN;
	} else if (gain > OV16A1Q_MAXGAIN * BASEGAIN) {
		LOG_ERR("Invaild gain: %d\n", gain);
		gain = OV16A1Q_MAXGAIN * BASEGAIN;
	}
...
static kal_uint32 feature_control_ov16a1q_ofilm(MSDK_SENSOR_FEATURE_ENUM feature_id,
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	get_info,
	get_resolution,
	feature_control_ov16a1q_ofilm,
	control,
	close
};

UINT32 OV16A1Q_OFILM_SensorInit(struct SENSOR_FUNCTION_STRUCT **pf_func)
{
	if (pf_func != NULL)
		*pf_func = &sensor_func;
	return ERROR_NONE;
