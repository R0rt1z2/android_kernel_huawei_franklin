/*
 * ov48b2q_luxvisions_sensor.h
 *
 * Copyright (c) 2018-2019 Huawei Technologies Co., Ltd.
 *
 * ov48b2q_luxvisions image sensor config settings
 *
...
#ifndef _OV48B2Q_LUXVISIONS_SENSOR_H
#define _OV48B2Q_LUXVISIONS_SENSOR_H
...
#define EEPROM_LENS_TYPE_ADDR 0x04 /* LENS type addr in otp map. */
...
// 4000x3000 30.3fps hts: 1056 pixels (nternal) vts: 3600 lines pclk = 115.2Mhz
// tline = 9.167us vb=5.5ms min_exposure=2 max_exposure=vts-12
	{ 0x0344, 0x01, 0x00 },
	{ 0x0345, 0x22, 0x00 },
	{ 0x0350, 0x01, 0x00 },
	{ 0x3500, 0x00, 0x00 },
...
// 4000x2256 30.3fps hts:1056 pixels (internal) vts:3600 lines pclk=115.2Mhz
// tline=9.167us vb=12.32ms min_exposure=2 max_exposure=vts-12
	{ 0x0344, 0x01, 0x00 },
	{ 0x0345, 0x22, 0x00 },
	{ 0x0350, 0x01, 0x00 },
	{ 0x3500, 0x00, 0x00 },
...
static struct imgsensor_i2c_reg test_partern_on[] = {
	// { 0x5081, 0x0, 0x0, 0x01, 0x00 },
};

static struct imgsensor_i2c_reg test_partern_off[] = {
	// { 0x5081, 0x00, 0x00 0xFE, 0x00},
};
...
static struct imgsensor_i2c_reg_setting normal_to_long_ready_settings = {
...
static struct imgsensor_i2c_reg_setting normal_to_long_end_settings = {
...
static struct imgsensor_info_t imgsensor_info = {
	...
	.min_gain_iso = 100,
	.max_gain = 1024,
	.sensor_id = OV48B2Q_LUXVISIONS_SENSOR_ID,
