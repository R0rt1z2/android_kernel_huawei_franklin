...
enum IMGSENSOR_RETURN (*hw_open[IMGSENSOR_HW_ID_MAX_NUM])
	...
	imgsensor_hw_hwpmic_open,
};

struct IMGSENSOR_HW_CFG imgsensor_6885_config[] = {
	{
...
struct IMGSENSOR_HW_CFG imgsensor_yorv4_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
			{ IMGSENSOR_HW_PIN_MCLK,  IMGSENSOR_HW_ID_MCLK },
			{ IMGSENSOR_HW_PIN_LDO1_PMIC,  IMGSENSOR_HW_ID_HWPMIC },
			{ IMGSENSOR_HW_PIN_XBUCK1_PMIC,  IMGSENSOR_HW_ID_HWPMIC },
			{ IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR },
		...
		IMGSENSOR_I2C_DEV_1,
		{
			{ IMGSENSOR_HW_PIN_MCLK,  IMGSENSOR_HW_ID_MCLK },
			{ IMGSENSOR_HW_PIN_LDO1_PMIC,  IMGSENSOR_HW_ID_HWPMIC },
			{ IMGSENSOR_HW_PIN_LDO2_PMIC,  IMGSENSOR_HW_ID_HWPMIC },
			{ IMGSENSOR_HW_PIN_LDO3_PMIC,  IMGSENSOR_HW_ID_HWPMIC },
			{ IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR },
			{ IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO },
			{ IMGSENSOR_HW_PIN_NONE,  IMGSENSOR_HW_ID_NONE },
		},
		...
		IMGSENSOR_I2C_DEV_2,
		{
			{ IMGSENSOR_HW_PIN_MCLK,  IMGSENSOR_HW_ID_MCLK },
			{ IMGSENSOR_HW_PIN_LDO1_PMIC,  IMGSENSOR_HW_ID_HWPMIC },
			{ IMGSENSOR_HW_PIN_LDO4_PMIC,  IMGSENSOR_HW_ID_HWPMIC },
			{ IMGSENSOR_HW_PIN_XBUCK1_PMIC,  IMGSENSOR_HW_ID_HWPMIC },
			{ IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR },
			{ IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO },
			{ IMGSENSOR_HW_PIN_NONE,  IMGSENSOR_HW_ID_NONE },
...
struct IMGSENSOR_HW_CFG imgsensor_yor_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_oce_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
			{ IMGSENSOR_HW_PIN_MCLK,    IMGSENSOR_HW_ID_MCLK },
			{ IMGSENSOR_HW_PIN_5V_BOOST, IMGSENSOR_HW_ID_GPIO },
			{ IMGSENSOR_HW_PIN_AVDD_SEL, IMGSENSOR_HW_ID_GPIO },
			{ IMGSENSOR_HW_PIN_DVDD_EN, IMGSENSOR_HW_ID_GPIO },
			{ IMGSENSOR_HW_PIN_DVDD_SEL, IMGSENSOR_HW_ID_GPIO },
			{ IMGSENSOR_HW_PIN_AVDD1_EN, IMGSENSOR_HW_ID_GPIO },
...
struct IMGSENSOR_HW_CFG imgsensor_abr_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_mrr_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
const product_custom_cfg_map g_product_cfg_map[] = {
	{ "York", &imgsensor_yor_config[0] }, // for default
	{ "YorkV4", &imgsensor_yorv4_config[0] }, // for default
	{ "Ocean", &imgsensor_oce_config[0] },
	{ "Mrr", &imgsensor_mrr_config[0] },
	{ "Amber", &imgsensor_abr_config[0] },
};
...
void get_imgsensor_custom_conf(const char *product_name)
{
	...
	for (i = 0; i < size; ++i) {
		if (!strcmp(product_name, g_product_cfg_map[i].product_name)) {
			...
			PK_INFO("imgsensor custom config get %s", product_name);
			break;
		}
	}
	if (i == size) {
