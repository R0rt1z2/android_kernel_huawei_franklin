...
enum IMGSENSOR_HW_PIN {
	...
	IMGSENSOR_HW_PIN_VMCH,
	IMGSENSOR_HW_PIN_AFVDD,
	/* regulator pin end */
	/* pmic begin */
	IMGSENSOR_HW_PIN_LDO1_PMIC,
	IMGSENSOR_HW_PIN_LDO2_PMIC,
	IMGSENSOR_HW_PIN_LDO3_PMIC,
	IMGSENSOR_HW_PIN_LDO4_PMIC,
	IMGSENSOR_HW_PIN_XBUCK1_PMIC,
	/* pmic end */
#ifdef MIPI_SWITCH
