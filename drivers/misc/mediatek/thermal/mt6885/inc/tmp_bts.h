...
#define BTS_TAP_OVER_CRITICAL_LOW	188500 /* base on 100K NTC temp
						 * default value -40 deg
						 */

#define BTS_RAP_PULL_UP_VOLTAGE		1800 /* 1.8V ,pull up voltage */

#define BTS_RAP_NTC_TABLE		8 /* default is NCP15WF104F03RC(10K) */
...
#define BTSUSBNTC_RAP_PULL_UP_R		22000 /* 22K, pull up resister */
