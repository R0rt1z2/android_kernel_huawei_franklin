#include "eeprom_back_wide_ex_camera.h"

// wn project wide 5M camera otp
static struct eeprom_hw_i2c_reg eeprom_map[] = {
	{ 0x00, EEPROM_I2C_WORD_ADDR, 39,
		EEPROM_I2C_BYTE_DATA, EEPROM_I2C_READ, 0x00 },
	{ 0x0af4, EEPROM_I2C_WORD_ADDR, 2489,
		EEPROM_I2C_BYTE_DATA, EEPROM_I2C_READ, 0x00 },
	{ 0x163F, EEPROM_I2C_WORD_ADDR, 2400,
		EEPROM_I2C_BYTE_DATA, EEPROM_I2C_READ, 0x00 },
};
...
int eeprom_back_wide_ex_camera_get_map(unsigned int sensor_id,
