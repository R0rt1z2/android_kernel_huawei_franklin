#include "eeprom_back_ex_camera.h"

static struct eeprom_hw_i2c_reg frl_eeprom_map[] = { // C591
	{ 0x00, EEPROM_I2C_WORD_ADDR, 38,
		EEPROM_I2C_BYTE_DATA, EEPROM_I2C_READ, 0x00 },
	{ 0x0AED, EEPROM_I2C_WORD_ADDR, 2443,
		EEPROM_I2C_BYTE_DATA, EEPROM_I2C_READ, 0x00 },
	{ 0x1479, EEPROM_I2C_WORD_ADDR, 1895,
		EEPROM_I2C_BYTE_DATA, EEPROM_I2C_READ, 0x00 },
};
...
int eeprom_back_ex_camera_get_map(unsigned int sensor_id,
