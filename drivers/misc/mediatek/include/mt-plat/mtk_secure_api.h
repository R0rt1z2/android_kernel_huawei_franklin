...
/* I2C DEVICE WRITE SMC call */
#define MTK_SIP_KERNEL_I2C_DEVICE_WRITE_AARCH32 0x820002C2
/* I2C SET SLAVE ADDR SMC call */
#define MTK_SIP_KERNEL_I2C_SET_SLAVE_ADDR_AARCH32 0x820002C3
