...
#define HUAWEI_SECMEM_FLAGS 0x20u
...
#ifdef CONFIG_HW_SECMEM
	[SSMR_HUAWEI_SECMEM] = {
		.name = "huawei_secmem_scheme",
		.flags = HUAWEI_SECMEM_FLAGS
	},
#endif
};
...
#ifdef CONFIG_HW_SECMEM
	[SSMR_FEAT_HW_SECMEM] = {
		.dt_prop_name = "huawei-secmem-size",
		.feat_name = "huawei-secmem",
		.cmd_online = "huawei-secmem=on",
		.cmd_offline = "huawei-secmem=off",
		.scheme_flag = HUAWEI_SECMEM_FLAGS
	},
#endif
};
