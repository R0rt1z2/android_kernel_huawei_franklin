...
int kbase_device_init(struct kbase_device * const kbdev)
{
	...
	mutex_init(&kbdev->dev_data.atom_queue_mutex);
	INIT_LIST_HEAD(&kbdev->dev_data.atom_queue_head);
#endif

#ifdef CONFIG_MALI_HUAWEI_CL_BOOST
	kbdev->dev_data.callbacks = (struct kbase_huawei_callbacks *)gpu_get_callbacks();
#endif
