...
static const struct of_device_id match_table[] = {
	{ .compatible = "huawei,arm-memlat-mon" },
	{}
};
...
static int __init arm_memlat_mon_init(void)
{
	...
	if (!ret) {
		cpuhp_setup_state_nocalls(CPUHP_AP_ARM_MEMLAT_MON_NOTIFY_PREPARE,
...
static void __exit arm_memlat_mon_exit(void)
{
	...
	cpuhp_remove_state_nocalls(CPUHP_AP_ARM_MEMLAT_MON_NOTIFY_PREPARE);
