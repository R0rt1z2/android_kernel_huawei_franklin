...
#ifndef __HUAWEI_CONTEXTHUB_HUAWEI_FLP_H__
#define __HUAWEI_CONTEXTHUB_HUAWEI_FLP_H__
 ...
 */
extern int  huawei_flp_register(void);
/*
 * unregister for Fused Location Provider function
 */
extern int  huawei_flp_unregister(void);
/*
