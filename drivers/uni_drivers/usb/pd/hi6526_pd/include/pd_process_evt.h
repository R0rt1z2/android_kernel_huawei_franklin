...
bool hi6526_pd_process_ctrl_msg_vconn_swap(pd_port_t *pd_port, pd_event_t *pd_event);
bool hi6526_pd_process_recv_hard_reset(pd_port_t *pd_port, pd_event_t *pd_event, uint8_t hreset_state);
...
bool hi6526_pd_make_pe_state_transit_virt(pd_port_t *pd_port, uint8_t curr_state,
	const pe_state_reaction_t *state_reaction);
bool hi6526_pd_make_pe_state_transit_force(pd_port_t *pd_port,
...
bool hi6526_pd_process_event(pd_port_t *pd_port, pd_event_t *pd_event, bool vdm_evt);
bool hi6526_pd_process_event_snk(pd_port_t *pd_port, pd_event_t *evt);
bool hi6526_pd_process_event_src(pd_port_t *pd_port, pd_event_t *evt);
bool hi6526_pd_process_event_drs(pd_port_t *pd_port, pd_event_t *evt);
bool hi6526_pd_process_event_prs(pd_port_t *pd_port, pd_event_t *evt);
bool hi6526_pd_process_event_vdm(pd_port_t *pd_port, pd_event_t *evt);
bool hi6526_pd_process_event_vcs(pd_port_t *pd_port, pd_event_t *evt);
bool hi6526_pd_process_event_tcp(pd_port_t *pd_port, pd_event_t *pd_event);

#ifdef CONFIG_USB_PD_CUSTOM_DBGACC_SUPPORT
bool hi6526_pd_process_event_dbg(pd_port_t *pd_port, pd_event_t *evt);
#endif
