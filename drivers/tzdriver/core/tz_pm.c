...
{
	register u32 smc_id asm("r0") = (u32)power_op;
...
static uint32_t tc_s4_crypto_and_copy(uint32_t crypt_op,
	...
	uint32_t size, uint32_t index)
{
	register u32 smc_id asm("r0") = (u32)crypt_op;
	register u32 arg0 asm("r1") = (u32)middle_mem_addr;
	register u32 arg1 asm("r2") = (u32)secos_mem;
	register u32 arg2 asm("r3") = (u32)size;
	register u32 arg3 asm("r4") = (u32)index;
