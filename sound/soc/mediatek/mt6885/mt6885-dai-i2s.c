...
static const struct snd_kcontrol_new fac_i2s7_mux_control =
	SOC_DAPM_ENUM("FAC_I2S7 Select", fac_i2s_mux_map_enum);
...
static const struct snd_kcontrol_new fac_i2s7_link_mux_control =
	SOC_DAPM_ENUM("FAC_I2S7 LINK", fac_i2s_link_mux_map_enum);

static const struct snd_kcontrol_new fac_i2s3_mix[] = {
	SOC_DAPM_SINGLE("FAC_I2S3_Switch", SND_SOC_NOPM, 0, 1, 0),
};

static const struct snd_kcontrol_new fac_i2s7_mix[] = {
	SOC_DAPM_SINGLE("FAC_I2S7_Switch", SND_SOC_NOPM, 0, 1, 0),
};
			...
			struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		rate_reg = mt6885_rate_transform(afe->dev, rate, i2s_id);
...
static int fac_i2s7_config_power_event(struct snd_soc_dapm_widget *w,
			struct snd_kcontrol *kcontrol, int event)
{
	unsigned int rate_reg;
	int i2s_id = MT6885_DAI_I2S_7;
	snd_pcm_format_t format = SNDRV_PCM_FORMAT_S32_LE;
	unsigned int rate = 48000; // sample rate
	unsigned int i2s_con;
	struct snd_soc_component *cmpnt = snd_soc_dapm_to_component(w->dapm);
...
static const struct snd_soc_dapm_widget mtk_dai_i2s_widgets[] = {
	...
	SND_SOC_DAPM_MUX_E("FAC_I2S7_Select", SND_SOC_NOPM, 0, 0,
			&fac_i2s7_mux_control,
			fac_i2s7_config_power_event,
			SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_PRE_PMD),

	SND_SOC_DAPM_MUX("FAC_I2S7_Link", SND_SOC_NOPM,
			0, 0, &fac_i2s7_link_mux_control),

	SND_SOC_DAPM_MIXER("FAC_I2S3_MIXER", SND_SOC_NOPM, 0, 0,
			fac_i2s3_mix,
			ARRAY_SIZE(fac_i2s3_mix)),

	SND_SOC_DAPM_MIXER("FAC_I2S7_MIXER", SND_SOC_NOPM, 0, 0,
			fac_i2s7_mix,
			ARRAY_SIZE(fac_i2s7_mix)),
...
static const struct snd_soc_dapm_route mtk_dai_i2s_routes[] = {
	...
	/* i2s7 */
	{"I2S7_CH1", "DL1_CH1", "DL1"},
	{"I2S7_CH2", "DL1_CH2", "DL1"},

	{"I2S7_CH1", "DL2_CH1", "DL2"},
	{"I2S7_CH2", "DL2_CH2", "DL2"},

	{"I2S7_CH1", "DL3_CH1", "DL3"},
	{"I2S7_CH2", "DL3_CH2", "DL3"},

	{"I2S7_CH1", "DL12_CH1", "DL12"},
	{"I2S7_CH2", "DL12_CH2", "DL12"},

	{"I2S7_CH1", "DL6_CH1", "DL6"},
	{"I2S7_CH2", "DL6_CH2", "DL6"},

	{"I2S7_CH1", "DL4_CH1", "DL4"},
	{"I2S7_CH2", "DL4_CH2", "DL4"},

	{"I2S7_CH1", "DL8_CH1", "DL8"},
	{"I2S7_CH2", "DL8_CH2", "DL8"},

	{"I2S7_CH1", "DL5_CH1", "DL5"},
	{"I2S7_CH2", "DL5_CH2", "DL5"},
	...
	{"I2S2_In_Mux", "Output_Widget", "I2S_DUMMY_IN"},
	...
	/* i2s7 clk enbale for fac test */
	{"FAC_I2S7_Select", "Connect", "FAC_I2S_IN"},
	{"FAC_I2S7_MIXER", "FAC_I2S7_Switch", "FAC_I2S7_Select"},
	{"I2S7", NULL, "FAC_I2S7_MIXER"},
	{"FAC_I2S7_Link", "Connect", "I2S7"},
	{"FAC_I2S_DUMMY_OUT", NULL, "FAC_I2S7_Link"},
