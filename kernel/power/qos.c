...
static BLOCKING_NOTIFIER_HEAD(memory_lat_notifier);
static struct pm_qos_constraints memory_lat_constraints = {
	.req_list = LIST_HEAD_INIT(memory_lat_constraints.req_list),
	.list = PLIST_HEAD_INIT(memory_lat_constraints.list),
	...
	.type = PM_QOS_MAX,
	.qos_lock = __MUTEX_INITIALIZER(memory_lat_constraints.qos_lock),
	.notifiers = &memory_lat_notifier,
};
static struct pm_qos_object memory_lat_pm_qos = {
	.constraints = &memory_lat_constraints,
	.name = "memory_latency",
};
#endif
...
static struct pm_qos_constraints freq_link_level_constraints = {
	...
	.type = PM_QOS_MIN,
	.qos_lock = __MUTEX_INITIALIZER(freq_link_level_constraints.qos_lock),
