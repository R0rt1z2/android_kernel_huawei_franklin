...
#if defined(CONFIG_MAS_CMDLINE_PARSE)
	is_recovery_mode = get_boot_into_recovery_flag() == 1;
#elif defined(CONFIG_MTK_BOOT)
	is_recovery_mode = get_boot_mode() == RECOVERY_BOOT;
#endif
