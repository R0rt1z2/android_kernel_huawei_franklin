...
#if 1
extern ssize_t mas_queue_flush_reduce_show(struct request_queue *q, char *page);
extern ssize_t mas_queue_flush_reduce_store(
	struct request_queue *q, const char *page, size_t count);
#endif
extern ssize_t mas_queue_direct_flush_store(
	struct request_queue *q, const char *page, size_t count);
#else
static inline void mas_blk_rdr_panic(char *msg)
{
