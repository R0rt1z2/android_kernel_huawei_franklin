...
static inline u32 __crc32_pmull_le(const u8 buf[], u64 len, u32 init_crc)
{
	return crc32_pmull_le(buf, len, init_crc);
}
#define crc32_pmull_le __crc32_pmull_le
#endif

asmlinkage u32 crc32_armv8_le(u32 init_crc, const u8 buf[], size_t len);
#ifdef CONFIG_CFI_CLANG
static inline u32 __crc32_armv8_le(u32 init_crc, const u8 buf[], size_t len)
{
	return crc32_armv8_le(init_crc, buf, len);
}
#define crc32_armv8_le __crc32_armv8_le
#endif

asmlinkage u32 crc32c_pmull_le(const u8 buf[], u64 len, u32 init_crc);
#ifdef CONFIG_CFI_CLANG
static inline u32 __crc32c_pmull_le(const u8 buf[], u64 len, u32 init_crc)
{
	return crc32c_pmull_le(buf, len, init_crc);
}
#define crc32c_pmull_le __crc32c_pmull_le
#endif

asmlinkage u32 crc32c_armv8_le(u32 init_crc, const u8 buf[], size_t len);
#ifdef CONFIG_CFI_CLANG
static inline u32 __crc32c_armv8_le(u32 init_crc, const u8 buf[], size_t len)
{
	return crc32c_armv8_le(init_crc, buf, len);
}
#define crc32c_armv8_le __crc32c_armv8_le
#endif
