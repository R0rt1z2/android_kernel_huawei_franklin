...
static inline const char *direct_charge_get_stage_status_string(unsigned int stage)
{
...
static inline int direct_charge_get_info(enum direct_charge_info_type type, int *value)
{
	return -1;
}
...
static inline int direct_charge_get_adapter_gain_current(struct direct_charge_device *di)
{
	return 0;
}
