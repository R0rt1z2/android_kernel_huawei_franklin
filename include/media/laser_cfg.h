...
#define HWLASER_IOCTL_CONFIG\
	_IOWR(LASER_MAGIC, 0x02, hwlaser_config_data_t)
#define HWLASER_IOCTL_POWERON\
	_IO(LASER_MAGIC, 0x03)
#define HWLASER_IOCTL_MATCHID\
	_IOWR(LASER_MAGIC, 0x04, hwlaser_status_t)
#define HWLASER_IOCTL_POWEROFF\
	_IO(LASER_MAGIC, 0x05)
#define HWLASER_IOCTL_INIT\
	_IO(LASER_MAGIC, 0x06)
#define HWLASER_IOCTL_CALIBRATION_DATA\
	_IOWR(LASER_MAGIC, 0x07, hwlaser_calibration_data_t)
#define HWLASER_IOCTL_PARAMETER\
	_IOWR(LASER_MAGIC, 0x08, hwlaser_parameter_t)
#define HWLASER_IOCTL_ROI\
	_IOWR(LASER_MAGIC, 0x09, hwlaser_roi_full_t)
#define HWLASER_IOCTL_START\
	_IO(LASER_MAGIC, 0x10)
#define HWLASER_IOCTL_STOP\
	_IO(LASER_MAGIC, 0x11)
#define HWLASER_IOCTL_MZ_DATA\
	_IOWR(LASER_MAGIC, 0x12, hwlaser_RangingData_t)
#define HWLASER_IOCTL_PERFORM_CALIBRATION\
	_IOWR(LASER_MAGIC, 0x13, hwlaser_ioctl_perform_calibration_t)
